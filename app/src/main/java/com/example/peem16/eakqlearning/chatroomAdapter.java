...
public class chatroomAdapter extends ArrayAdapter<HashMap<String,Object>>{
    private LayoutInflater mInflater;
    private ArrayList<HashMap<String,Object>> mArray;
    private HashMap<String,Object> map;
    private int iView;
    private static Context context;
    public chatroomAdapter(Context c, int layoutView, ArrayList<HashMap<String, Object>> objects) {
...
//            holder.txtCount = (TextView)convertView.findViewById(R.id.txtBookCount);
        ...
        holder.txtTitle.setText(map.get(FieldConstants.name).toString()+" ห้อง "+map.get(FieldConstants.number).toString());

        holder.txtTitle2.setText(map.get(FieldConstants.Start_time).toString()+" - "+map.get(FieldConstants.End_time).toString());
