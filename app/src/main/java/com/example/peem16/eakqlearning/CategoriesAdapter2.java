...
public class CategoriesAdapter2 extends ArrayAdapter<HashMap<String,Object>>{
    private LayoutInflater mInflater;
    private ArrayList<HashMap<String,Object>> mArray;
    private HashMap<String,Object> map;
    private int iView;
    private static Context context;
    public CategoriesAdapter2(Context c, int layoutView, ArrayList<HashMap<String, Object>> objects) {
...
//            holder.txtCount = (TextView)convertView.findViewById(R.id.txtBookCount);
      ...
      String  dayOfTheWeek = (String) DateFormat.format("EEEE", date);
        ...
        if(map.get(FieldConstants.title).toString().equals("1")){
            ...
            holder.txtTitle.setText("วิชา "+map.get(FieldConstants.name).toString()+"(ชดเชย) \n วัน "+map.get(FieldConstants.date).toString()+"\n"+dayOfTheWeek2);
