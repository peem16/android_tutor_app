...
public class payreserAdapter extends ArrayAdapter<HashMap<String,Object>>{
    private LayoutInflater mInflater;
    private ArrayList<HashMap<String,Object>> mArray;
    private HashMap<String,Object> map;
    private int iView;
    private static Context context;
    public payreserAdapter(Context c, int layoutView, ArrayList<HashMap<String, Object>> objects) {
...
//            holder.txtCount = (TextView)convertView.findViewById(R.id.txtBookCount);
        ...
        holder.txtTitle.setText(map.get(FieldConstants.name).toString()+" วันเวลา "+map.get(FieldConstants.day).toString());
