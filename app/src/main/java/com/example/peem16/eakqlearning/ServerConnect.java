...
public class ServerConnect {
    ...
    public static String KEY_SERVER = "http://10.10.95.19/";
    public static String KEY_SERVER2 = "http://10.10.95.19//tutor3/androidphp/";
    public static Context context;
    public static String getServerKey(){


        return "http://10.10.95.19///";

    }

    public static String getServerKey2(){

        return "http://10.10.95.19/tutor3/androidphp/";
