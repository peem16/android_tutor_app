...
public class mysystemAdapter extends ArrayAdapter<HashMap<String, Object>> {
    ...
    public mysystemAdapter(Context context, int ViewResourceId, ArrayList<HashMap<String, Object>> objects) {
...
//            holder.position = position;
        ...
        holder.name.setText(map.get(FieldConstants.customer_order_no).toString());
        holder.date.setText("");
        holder.status.setText("สถานะ "+map.get(FieldConstants.o_status).toString());
